/**
 * cvi_glossy_lib.js 1.6 (14-Jul-2009)
...
var cvi_glossy = {
	...
	add: function(image, options) {
		if(image.tagName.toUpperCase() == "IMG") {
			var defopts = { "radius" : cvi_glossy.defaultRadius, "color" : cvi_glossy.defaultColor, "color2" : cvi_glossy.defaultColor2, "gradient" : cvi_glossy.defaultGradient, "shadow" : cvi_glossy.defaultShadow, "shade" : cvi_glossy.defaultShade, "noshadow" : cvi_glossy.defaultNoshadow, "noradius" : cvi_glossy.defaultNoradius, "filter" : cvi_glossy.defaultFilter, "callback" : cvi_glossy.defaultCallback }
			if(options) {
